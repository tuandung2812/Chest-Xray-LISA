...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        if type(images) is list or images.ndim == 5:
            ...
            # This line is execute. 
            image_features = self.encode_images(images).to(self.device)
            # image_features: [B*3, 256,4096]
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            for i in range(num_images + 1):
                ...
                if i < num_images:
                    ...
                    # Here we are defining the labels baed on the image features
        ...
        return None, position_ids, attention_mask, past_key_values, new_input_embeds, new_labels, image_token_indices
