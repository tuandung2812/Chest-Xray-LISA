...
from model_hub.llava.llava_0.constants import (DEFAULT_IM_END_TOKEN, DEFAULT_IM_START_TOKEN,
                         DEFAULT_IMAGE_PATCH_TOKEN)

from model_hub.llava.llava_0.model.language_model.llava_mistral import (LlavaMistralForCausalLM,
                                                     LlavaMistralModel)
from model_hub.sam.sam_0 import build_sam_vit_h, build_sam_vit_b
    ...
    def model_forward(
        ...
        **kwargs,
        ...
        if inference:
            ...
            assert images_clip.shape[0] == 1, images_clip.shape
