...
from model_hub.chexagent.chexagent_hf_explained.build_chexagent_explained import chexagent_explained_model_registry


class ChexagentExplained_Handler:
    ...
    def initialize(self, context):
        ...
        self.model = chexagent_explained_model_registry[context.model_id](
