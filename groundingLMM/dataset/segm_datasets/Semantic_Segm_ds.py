...
def init_ade20k(dataset_dir):
    ...
    ade20k_image_dir = os.path.join("dataset/final_data/Semantic_Segm", "ade20k", "images", "training")
...
if __name__ == '__main__':
    ...
    dataset = SemanticSegmDataset(dataset_dir='./',tokenizer=tokenizer, global_image_encoder = "openai/clip-vit-large-patch14",semantic_segm_data="ade20k",num_classes_per_sample=5)
