...
from dataset.vindr_datasets.vindr_dataset import VinDrDataset
def parse_args(args):
...
#         train_datasets = []
    ...
    train_datasets  = [VinDrDataset(base_dir= args.dataset_dir,tokenizer= tokenizer,
                      global_image_encoder= args.vision_tower,
                      epoch_samples= args.batch_size * args.grad_accumulation_steps *args.steps_per_epoch * world_size,split='train')]
    world_size = torch.cuda.device_count()
    ...
    val_datasets = []
    if not args.no_eval:
        val_datasets  = [VinDrDataset(base_dir= args.dataset_dir,tokenizer= tokenizer,
                      global_image_encoder= args.vision_tower,
                      epoch_samples= args.batch_size * args.grad_accumulation_steps *args.steps_per_epoch * world_size,split='val')]
