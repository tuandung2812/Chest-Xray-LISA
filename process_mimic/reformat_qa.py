...
with open('process_mimic/mimic_qa_data_train.json') as f:
    train_data = json.load(f)
# print(train_data)
...
with open('process_mimic/mimic_qa_data_train_newformat.json','w') as f:
    json.dump(new_train_data,f)
    # train_data = json.load(f)

with open('process_mimic/mimic_qa_data_test.json') as f:
    train_data = json.load(f)
# print(train_data)
...
with open('process_mimic/mimic_qa_data_test_newformat.json','w') as f:
    json.dump(new_train_data,f)
    # train_data = json.load(f)
